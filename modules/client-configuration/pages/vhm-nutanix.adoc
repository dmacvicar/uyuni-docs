...
To run a VHM, your {productname} Server must have access to port 9440 on the Nutanix Prism Element API.
...
If this occurs, refreshing the data from the virtual host manager will fail.
